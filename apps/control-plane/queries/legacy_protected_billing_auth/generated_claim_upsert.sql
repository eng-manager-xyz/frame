INSERT INTO legacy_protected_billing_auth_generated_replay_claims_v1(
...
WHERE EXISTS (
  ...
  WHERE prior.receipt_id = legacy_protected_billing_auth_generated_replay_claims_v1.receipt_id
