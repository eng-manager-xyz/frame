...
The current exact partition is 362 locally satisfied, 176 protected pending,
and 16 true repository-local gaps. The audited native-product gaps are issue 25
checkboxes 6/7/8, issue 27 checkboxes 4/5/8/9/10/11, and issue 33
