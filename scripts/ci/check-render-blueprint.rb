...
if web.nil?
  ...
  required_paths = %w[apps/web/** crates/** fixtures/web-authenticated/** Cargo.toml Cargo.lock package.json package-lock.json rust-toolchain.toml scripts/ci/** render.yaml]
